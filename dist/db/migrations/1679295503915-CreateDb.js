...
exports.CreateDb1679295503915 = void 0;
class CreateDb1679295503915 {
    constructor() {
        this.name = 'CreateDb1679295503915';
    }
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE \`tb_branch\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`status\` tinyint NOT NULL DEFAULT 1, \`deleted\` tinyint NOT NULL DEFAULT 0, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`tb_account\` (\`id\` int NOT NULL AUTO_INCREMENT, \`telephone\` varchar(255) NOT NULL, \`email\` varchar(255) NOT NULL, \`fullname\` varchar(255) NULL, \`password\` varchar(255) NOT NULL, \`status\` tinyint NOT NULL DEFAULT 1, \`description\` varchar(255) NULL, \`sex\` tinyint NOT NULL DEFAULT 1, \`full_address\` varchar(255) NOT NULL, \`deleted\` tinyint NOT NULL DEFAULT 0, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`branchId\` int NULL, UNIQUE INDEX \`IDX_b8ad71f7ae902671fc9577b894\` (\`telephone\`), UNIQUE INDEX \`IDX_3741553369b2b4ee0515ad17ef\` (\`email\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`tb_account\` ADD CONSTRAINT \`FK_736bd47c5c9b13aa207551196d7\` FOREIGN KEY (\`branchId\`) REFERENCES \`tb_branch\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`tb_account\` DROP FOREIGN KEY \`FK_736bd47c5c9b13aa207551196d7\``);
        ...
        await queryRunner.query(`DROP TABLE \`tb_branch\``);
    }
}
exports.CreateDb1679295503915 = CreateDb1679295503915;
//# sourceMappingURL=1679295503915-CreateDb.js.map